import Taro, { getStorageSync, setStorageSync, createSelectorQuery } from '@tarojs/taro';
...
const VerifySlideFixed = (props: any) => {
  ...
  // const [tipsBackColor, setTipsBackColor] = useState('');
  ...
  const end = () => {
    ...
    // setEndMovetime(currentEndMovetime);
  ...
  return (
    <View className="mask" style={{ display: isSlideShow ? 'block' : 'none' }}>
      <View className="verifybox" style={{ maxWidth: parseInt(String(imgSize.width)) + 30 + 'px' }}>
